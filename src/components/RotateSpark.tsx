...
const RotateSpark = ({ className, animationOption }: Props) => {
  return (
    <div
      className={className}
      dangerouslySetInnerHTML={{
        __html: `<svg class="animate-[rotating_${animationOption}_infinite]" width="162" height="144" viewBox="0 0 162 144" fill="none" xmlns="http://www.w3.org/2000/svg">
