...
busan, south korea`}</div>
        <RotateSpark className="absolute top-14 left-0 w-14 sm:w-10 flex" />
        <RotateSpark className="absolute top-0 left-5 w-20 sm:w-14 flex" />
        <RotateSpark className="absolute top-48 right-0 w-12 sm:w-10 sm:top-40 flex" />
      </div>
