...
import Introduce from "../../src/components/about/components/Introduce";
...
import AboutItem from "../../src/components/about/components/AboutItem";
import AboutListItem from "../../src/components/about/components/AboutListItem";
		...
		<div className="container min-w-full min-h-screen overflow-scroll flex flex-col items-center">
			...
			>
				...
				>
					...
					>
						<AboutListItem
							content={"Git, Github, Gitlab, Source tree"}
						/>
...
const borderClassName =
	"w-3/4 sm:w-5/6 text-xs border-blue border-8 xl:border-8 lg:border-8 md:border-8 sm:border-8  p-6 my-4";
